Webruntime.moduleRegistry.define('c/fullCalendarJs', ['lwc', 'webruntime/configProvider'], function (lwc, configProvider) { 'use strict';
  ...
  var FullCalendarJS = `${configProvider.getBasePath()}/assets/3e5901fcf0/FullCalendarJS`;
